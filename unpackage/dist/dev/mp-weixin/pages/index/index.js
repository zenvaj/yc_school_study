...
var _vuex = __webpack_require__(/*! vuex */ 6);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var cardSwiper = function cardSwiper() {__webpack_require__.e(/*! require.ensure | components/swiper/card-swiper */ "components/swiper/card-swiper").then((function () {return resolve(__webpack_require__(/*! ../../components/swiper/card-swiper.vue */ 347));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var menuGrid = function menuGrid() {__webpack_require__.e(/*! require.ensure | components/menu/menu-grid */ "components/menu/menu-grid").then((function () {return resolve(__webpack_require__(/*! ../../components/menu/menu-grid.vue */ 352));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var listCardScreen = function listCardScreen() {__webpack_require__.e(/*! require.ensure | components/list/list-card-screen */ "components/list/list-card-screen").then((function () {return resolve(__webpack_require__(/*! ../../components/list/list-card-screen.vue */ 357));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var listCard = function listCard() {__webpack_require__.e(/*! require.ensure | components/list/list-card */ "components/list/list-card").then((function () {return resolve(__webpack_require__(/*! ../../components/list/list-card.vue */ 362));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
{
  ...
  (0, _vuex.mapMutations)(['authLogin'])), {}, {
    swiperInit: function swiperInit() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  _this.$request({
                    method: '/api/banner',
                ...
                _this.swiperList = result.data;case 8:case "end":return _context.stop();}}}, _callee);}))();
    },
    //轮播点击方法
    navigeteBanner: function navigeteBanner(title) {
      console.log('navigeteBanner', title);
      uni.navigateTo({
        url: '/pages/public/content?title=' + title });

    },
    menuGridInit: function menuGridInit() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var result;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (

                  _this2.$request({
                    method: '/api/menus',
                    data: {} }));case 2:result = _context2.sent;

                console.log(result);if (!(
                result.code !== 10000)) {_context2.next = 7;break;}
                uni.showModal({
                  content: result.msg });return _context2.abrupt("return");case 7:



                _this2.menuGridList = result.data;case 8:case "end":return _context2.stop();}}}, _callee2);}))();
    },
    //九宫格点击方法
    ...
    hotNewsInit: function hotNewsInit() {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var result;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return (
                  _this3.$request({
                    method: '/api/index_news',
                    data: {} }));case 2:result = _context3.sent;

                console.log(result);if (!(
                result.code !== 10000)) {_context3.next = 7;break;}
                uni.showModal({
                  content: result.msg });return _context3.abrupt("return");case 7:



                _this3.hotNewsList = result.data.index_notice;
                _this3.newNewsList = result.data.index_news;case 9:case "end":return _context3.stop();}}}, _callee3);}))();
    },
    //文章点击方法
