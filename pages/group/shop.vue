	...
	<view class="container">
		...
		<scroll-view scroll-x class="bg-white nav" style="border-bottom: 2rpx solid #23f7ed;">
			<view class="flex text-center">
				<view class="cu-item flex-sub" :class="0 == TabCur ? 'bg-gradual-blue1 cur' : ''" @tap="TabCur = 0">商品</view>
				<view class="cu-item flex-sub" :class="1 == TabCur ? 'bg-gradual-blue2 cur' : ''" @tap="TabCur = 1">评价</view>
				<view class="cu-item flex-sub" :class="2 == TabCur ? 'bg-gradual-blue1 cur' : ''" @tap="TabCur = 2">门店介绍</view>
			</view>
		</scroll-view>

		<view class="goods padding-top-sm" style="padding-bottom: 166rpx;" v-if="0 == TabCur">
			<!-- 列表 -->
					...
					<view class="cart-item" :class="{ 'b-b': index !== cartList.length - 1 }">
						...
						<view class="item-right">
							...
							<view class="uni-numbox">
								...
								<input class="uni-numbox-value" type="number" disabled :value="inputValue" @blur="_onBlur" />
