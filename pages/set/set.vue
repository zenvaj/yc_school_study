<template>
	<view class="container cu-list menu card-menu margin-top">
		<!-- <view class="list-cell b-b m-t" @click="navTo('个人资料')" hover-class="cell-hover" :hover-stay-time="50">
			<text class="cell-tit">个人资料</text>
			<text class="cell-more yticon icon-you"></text>
		</view> -->
		<view class="list-cell b-b" @click="navToNologin('/pages/set/address')" hover-class="cell-hover" :hover-stay-time="50">
		...
		<view class="list-cell b-b" @click="navToNologin('/pages/public/icon-all')" hover-class="cell-hover" :hover-stay-time="50">
			<text class="cell-tit">所有图标</text>
			<text class="cell-more yticon icon-you"></text>
		</view>
